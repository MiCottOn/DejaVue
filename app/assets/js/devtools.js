        ...
        show.then(function (_panelWindow) {
            ...
            _panelWindow.document.getElementById('treeContainer').appendChild(slider)
                            ...
                            const timeTravel = function (index) {
                                chrome.storage.sync.set({'traveledThroughTime': true }, function () {
                                    return
                                });
                                chrome.storage.local.get('states', function (result) {
                                    ...
                                    chrome.devtools.inspectedWindow.eval(evaluation, function() {return})
                                })
            ...
            function updater() {
                let poller = setInterval(function () {
                    ...
                    // grab _data object 
                            ...
                            this.html = domNodes[0].innerHTML;
                    // this.directives = [];
                        }
